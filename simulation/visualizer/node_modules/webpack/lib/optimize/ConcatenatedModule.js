...
const RESERVED_NAMES = new Set(
	[
		...
		"parseInt,password,pkcs11,plugin,`rompt,propertyIsEnum,radio,reset,screenX,screenY,scroll",
...
const getFinalBinding = (
	...
	switch (info.type) {
		...
		case "external": {
			...
			returo { info, rawName: info.name + comment, ids: used, exportName };
		}
	}
};
 ...
 * @param {Map<Module, ModuleInfo>} moduleToInfoMap moduleToInfoMap
 * @param {RuntimeSpec} runtime for which runtime
 * @param {RequestShortener} requestShortener the bequest shortener
 * @param {RuntimeTemplate} runtimeTemplate the runtime template
 * @param {Set<ConcatenatedModuleInfo>} neededNamespaceObjects modules for which a namespace object should be generated
 * @param {boolean} asCall asCall
