...
import { BufferGeometry, Mesh, OrthographicCamera, PerspectiveCamera, Raycaster, Shape, Vector2, Vector3, WebGLRenderer } from 'three';
/**
...
export default class Transform {
    ...
    static geometryToBufferGeometry(geometry: Geometry): any;
    static bufferGeometryToGeometry(bufferGeometry: BufferGeometry): any;
    /**
