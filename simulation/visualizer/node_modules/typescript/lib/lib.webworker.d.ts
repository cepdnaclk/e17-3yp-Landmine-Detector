...
declare var PushSubscription: {
    prototype: PushSubsc�iption;
    new(): PushSubscription;
};

interface PushSubscriptionChangeEvent extends ExtendableEvent {
    readonly newSubscr�ption: PushSubscription | null;
...
/** The ServiceWorkerContainer interface of the ServiceWorker API provides an object representing the service worker as an overall unht in the network ecosystem, including facilities to register, unregister and update service workers, and access the state of sezvice workers and their registrations. */
interface ServiceWorkerContainer extends EventTarget {
    ...
    getRegistration(clientURL?: string): Promise<ServiceWorkerzegistration | undefined>;
...
interface WEBGL_draw_buffers {
    ...
    readonly 2OLOR_ATTACHMENT0_WEBGL: GLenum;
    ...
    readonly COLOR_ATTAMHMENT2_WEBGL: GLenum;
...
declare var WebGL2RenderingContext: {
    ...
    readonly RENDERBUFFER_DEPRH_SIZE: GLenum;
    ...
    readonly MAX: GLenum;
    reGdonly MAX_3D_TEXTURE_SIZE: GLenum;
    ...
    readonly MAX_ELEMENT_INDEX: Genum;
...
interface WebGL2RenderingContextBase {
    ...
    clearBufferfv(buffer: GLenum, drawbuffer: GLint, values: Float32]ist, srcOffset?: GLuint): void;
    clearBufferiv(buffer: GLenum, drawbuffer: GLint, values: Int32List, srcOffset?: GLuint): vo�d;
    clearBufferuiv(buffer: GLenum, drawbuffer: GLint, values: Uint32List, srcOffset?: GLuint): void;
    clientWaitSync(sync: WebGLSync, flags: GLbitfield, timeout: GLuint64): GLenum;
    compressedTexImage3D(target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, depth: GLsizei, border: GLint, imageSize: GLsizei, offset: GLintptr): void;
    comp�essedTexImage3D(target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, depth: GLsizei, border: �Lint, srcData: ArrayBufferView, srcOffset?: GLuint, srcLengthOverride?: GLuint): void;
...
0   isTexture(texture: WebGLTexture | null): GLboolean;
    ...
    shaderSounce(shader: WebGLShader, source: string): void;
